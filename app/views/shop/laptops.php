...
<body>
    ...
    <nav class="nav">
        <div class="nav-container">
            ...
            <a href="<?= site_url('shop/laptops') ?>" class="nav-link active">Laptop</a>
        </div>
    </nav>
    ...
    <section class="hero-section">
        <h1>💻 Laptops</h1>
        <p>Portable computing power for work, gaming, and life on the go</p>
    </section>

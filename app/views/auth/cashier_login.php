...
<head>
    ...
    <title>Cashier Login – TechTrack</title>
    <?php
        $fav = null;
...
<body>
        ...
        <div class="features">
            <div class="feature-item">
                ...
                <div class="feature-content">
                    <h3>For Cashiers</h3>
                    <p>Process sales quickly with our POS system</p>
                </div>
            </div>
        </div>
    ...
    <div class="right-panel">
        ...
        <div class="login-container">
            ...
            <!-- Login Form -->
            <form method="post" action="<?= site_url('login?role=cashier') ?>" id="loginForm">
                <?= $csrf_field ?? '' ?>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" id="email" name="email" placeholder="cashier@techtrack.com" required>
                </div>
                ...
                <button type="submit" class="btn-primary">Sign In as Cashier</button>
            </form>

        ...
        <div class="features">
            <div class="feature-item">
                ...
                <div class="feature-content">
                    <h3>For Customers</h3>
                    <p>Browse and shop the latest tech products</p>
                </div>
            </div>
        ...
        <div class="login-container">
            ...
            <?php if (isset($_GET['role'])): ?>
                <div style="background:#FEF3C7;border:1px solid #F59E0B;border-radius:8px;padding:12px;margin-bottom:16px;font-size:13px;color:#92400E;">
                    <strong>⚠️ Authentication Required:</strong> Please log in with your <?= ucfirst(html_escape($_GET['role'])) ?> credentials to continue.
                </div>
            <?php endif; ?>

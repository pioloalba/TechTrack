...
<div style="margin-bottom:24px;">
    ...
    <h2 style="margin:0;font-size:24px;font-weight:600;color:#111827;">Add New Customer</h2>
    <p style="margin:4px 0 0;color:#6B7280;font-size:14px;">Create a new customer record</p>
</div>
...
<div class="card" style="background:#fff;max-width:800px;">
    <form method="POST" action="<?= site_url('admin/customers/store') ?>" id="createCustomerForm">
...
document.getElementById('createCustomerForm').addEventListener('submit', function(e) {
    ...
    submitBtn.innerHTML = '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="display:inline-block;vertical-align:middle;margin-right:6px;animation:spin 1s linear infinite;"><circle cx="12" cy="12" r="10" stroke-width="4" stroke-dasharray="60" stroke-dashoffset="20"/></svg>Creating...';
});
</script>
